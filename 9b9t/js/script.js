document.addEventListener('DOMContentLoaded', () => {
    ...
    addToCartButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            const productName = product.querySelector('.card__title').innerText; // Используем новый класс .card__title
            const productPrice = parseFloat(product.getAttribute('data-price'));
            const productImage = product.querySelector('.card__img').src; // Используем новый класс .card__img
